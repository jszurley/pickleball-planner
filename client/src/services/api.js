...
export const approveGroupRequest = (groupId, userId) => api.post(`/groups/${groupId}/requests/${userId}/approve`);
export const rejectGroupRequest = (groupId, userId) => api.post(`/groups/${groupId}/requests/${userId}/reject`);
